        ...
        <div class="container-fluid with-nav">
            ...
            <div class="row create-new">
                ...
                <div class="col-md-10 col-sm-12 mx-auto">
                    <!--  ************ all form******************************** -->
                        <form action="{{URL::to('/admin/users')}}" method="post" class="row p-t-50" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <!-- ********* input ***************************-->
                        ...
                        <div class="form-group col-md-6 col-sm-12 row">
                            ...
                            <div class="d-inline-block col-sm-10 mx-auto">
                                <input type="text"  value="{{old('name')}}" class="form-control @if($errors->has('name'))  is-invalid @endif" name="name"  id="inputName"/>
                                @if($errors->has('name'))
                                    <div class="col-sm-3">
                        ...
                        <div class="form-group col-md-6 col-sm-12 row">
                            ...
                            <div class="d-inline-block col-sm-9 mx-auto">
                                <select class="form-control "  name="type" data-live-search="true"  id="type">
                                    ...
                                    <option value="Admin" @if(old('type')=='Admin' ) selected @endif  >مشرف</option>
                                    <option value="Teacher" @if(old('type')=='Teacher' ) selected @endif>مدرب</option>
                                    <option value="Student" @if(old('type')=='Student' ) selected @endif>متدرب</option>
                                </select>
                                @if($errors->has('type'))
                                    <div class="col-sm-3">
                                        <small id="passwordHelp" class="text-danger">
                        ...
                        <div class="form-group col-md-6 col-sm-12 row">
                            ...
                            <div class="d-inline-block col-sm-10 mx-auto">
                                <input type="email"  value="{{old('email')}}" class="form-control @if($errors->has('email'))  is-invalid @endif" name="email" id="inputEmail">
                                @if($errors->has('email'))
                                    <div class="col-sm-3">
                                        <small id="passwordHelp" class="text-danger">
                                            {{$errors->first('email')}}
                        ...
                        <div class="form-group col-md-6 col-sm-12 row  @if($errors->has('phone')) text-danger @endif">
                            ...
                            <div class="d-inline-block col-sm-10 mx-auto">
                                <input type="tel" value="{{old('phone')}}" class="form-control @if($errors->has('phone'))  is-invalid @endif" name="phone" id="inputTel">
                                @if($errors->has('phone'))
                                    <div class="col-sm-3">
                                        <small id="passwordHelp" class="text-danger">
                                            {{$errors->first('phone')}}
                        ...
                        <div class="form-group col-md-6 col-sm-12 row">
                            ...
                            <div class="d-inline-block col-sm-8 mx-auto">
                                ...
                                <img id="blah"  class="@if($errors->has('image'))  is-invalid @endif" src="{{URL::to('/')}}/Assets/images/icons8-photo-gallery-50.png" alt="user img" style="height: 60px;width: 60px"/>
